...
class UIExplorerModulesList extends React.Component {
  props: Props
    ...
    return this._renderRow(
      ...
      () => {
        this.props.onNavigate(
          UIExplorerActions.ModuleListWithFilter('')
        );
      }
    );
  }
  ...
  _handleRowPress(exampleKey: string): void {
    ...
    this.props.onNavigate(UIExplorerActions.ModuleAction(exampleKey, props));
  }
}

UIExplorerModulesList = UIExplorerStatePersister.createContainer(UIExplorerModulesList, {
...
module.exports = UIExplorerModulesList;
